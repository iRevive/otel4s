...
object LogRecord {
  ...
  private def toScalaSeverity(severity: JSeverity): Option[Severity] =
    severity match {
      ...
      case JSeverity.TRACE                     => Some(Severity.trace)
      case JSeverity.TRACE2                    => Some(Severity.trace2)
      case JSeverity.TRACE3                    => Some(Severity.trace3)
      case JSeverity.TRACE4                    => Some(Severity.trace4)
      case JSeverity.DEBUG                     => Some(Severity.debug)
      case JSeverity.DEBUG2                    => Some(Severity.debug2)
      case JSeverity.DEBUG3                    => Some(Severity.debug3)
      case JSeverity.DEBUG4                    => Some(Severity.debug4)
      case JSeverity.INFO                      => Some(Severity.info)
      case JSeverity.INFO2                     => Some(Severity.info2)
      case JSeverity.INFO3                     => Some(Severity.info3)
      case JSeverity.INFO4                     => Some(Severity.info4)
      case JSeverity.WARN                      => Some(Severity.warn)
      case JSeverity.WARN2                     => Some(Severity.warn2)
      case JSeverity.WARN3                     => Some(Severity.warn3)
      case JSeverity.WARN4                     => Some(Severity.warn4)
      case JSeverity.ERROR                     => Some(Severity.error)
      case JSeverity.ERROR2                    => Some(Severity.error2)
      case JSeverity.ERROR3                    => Some(Severity.error3)
      case JSeverity.ERROR4                    => Some(Severity.error4)
      case JSeverity.FATAL                     => Some(Severity.fatal)
      case JSeverity.FATAL2                    => Some(Severity.fatal2)
      case JSeverity.FATAL3                    => Some(Severity.fatal3)
      case JSeverity.FATAL4                    => Some(Severity.fatal4)
    }
